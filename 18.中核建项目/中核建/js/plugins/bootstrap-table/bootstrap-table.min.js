...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        pageNumber: 1,
        pageSize: 10,
        pageList: [10, 25, 50, 100, 'ALL'],//修改超过一百条显示所有分页按钮By 颜 2019-6-12
    ...
    BootstrapTable.prototype.fitHeader = function () {
        ...
        this.$body.find('>tr:first-child:not(.no-records-found) > *').each(function (i) {
			...
			//修改$th获取方法，修复若表格内有相同属性的列则表头错位的问题 By 颜 2019-6-26
			//方法不顶用啊，新版本，直接注释当前代码 并重写重绘表头代码---在下方 By 颜 2019-6-28
			//console.log(that.$header);
            //var $th = that.$header_.find(sprintf('th[data-field="%s"]', visibleFields[index]));
			/* var $th = that.$header_.find('tr:last th').eq(index);
            if ($th.length > 1) {
		...
		that.$header.find('tr').each(function(i){//并重写重绘表头代码 By 颜 2019-6-28
			var $tr = $(this);
			$tr.find('th').each(function(j){
				var th_width = $(this).find('.fht-cell')[0].getBoundingClientRect().width.toFixed(2);
				that.$header_.find('tr').eq(i).find('th').eq(j).find('.fht-cell').width(th_width);
			});
		});
    ...
    BootstrapTable.prototype.load = function (data) {
        ...
        if (this.options.pagination && this.options.sidePagination === 'server') {
            ...
            fixedScroll = data.fixedScroll;
            data = data.data||data.rows;//兼容客户端分页和服务端分页用同样的返回参数rows By 颜 2019-6-26
        }
    ...
    BootstrapTable.prototype.getAllColumns = function () {
       return this.columns;
    };
    ...
    var allowedMethods = [
        ...
        'updateFormatText', 'updateCellById','getAllColumns'
    ];
